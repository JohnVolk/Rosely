...
latex_documents = [
    (master_doc, 'Rosely.tex', 'Rosely Documentation',
     'John Volk', 'manual'),
]
...
man_pages = [
    (master_doc, 'rosely', 'Rosely Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Rosely', 'Rosely Documentation',
     author, 'Rosely', 'One line description of project.',
     'Miscellaneous'),
]
